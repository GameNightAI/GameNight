...
At Klack, your privacy is important to us. This Privacy Policy explains how we collect, use, disclose, and store your information when you use our application (“the App”).
...
Name (first and last): Optional, shared with other users as a form of identication

Email Address: Required for account creation and authentication.

Physical Address: Optional (as an event location), shared with other users

Other User Contact Info: BoardGameGeek username (optional)

b. User Content

Photos or Videos: Images captured by your device’s camera for AI analysis (board game recognition)

Other User Content:

* Board game collections: Collections stored are based on BoardGameGeek data and may also be edited manually

* Polls you create or participate in (titles, game options, votes, comments, and results)

* Game night events (titles, dates & times, locations, votes, comments, and results)
...
Polls and Events: Retained until you delete them or close your account
...
Account Deletion: Contact us at support@klack-app.com to delete your account

Data Removal: All personal data will be deleted within 30 days

Confirmation: You will receive confirmation of deletion via email
...
Immediate Processing: Images are processed without being collected

7. Children's Privacy

Our Service is not intended for children under 18 years of age. We do not knowingly collect personal information from children under 18. If you are a parent or guardian and believe your child has provided us with personal information, please contact us to have the information removed.
...
Contact Information (Name, Email Address, Physical Address, Other User Contact Info)
...
To request data export or deletion, email us at support@klack-app.com
