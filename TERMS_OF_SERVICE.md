...
## D. By using parts of our website, you indicate that you agree to the YouTube terms of service.
...
You consent to the collection, processing, and transfer of all your information and customer information by Klack and our partners as set forth in our [Privacy Policy](https://github.com/GameNightAI/GameNight/blob/develop/PRIVACY_POLICY.md). Klack may process that personal information as needed to facilitate polls, messages, or whichever activity it was given to us for. You can read about how we treat personal information in our [Privacy Policy](https://github.com/GameNightAI/GameNight/blob/develop/PRIVACY_POLICY.md).
...
# 8. You and BoardGameGeek are independent contractors. BoardGameGeek is not responsible for any issues you may have with merchants, traders, or any other users.
...
BoardGameGeek may terminate a user's access to the Geek Websites if the user is determined, in BoardGameGeek's sole discretion, to have infringed these Terms of Service. BoardGameGeek reserves the right to decide whether a User Submission is appropriate and complies with these Terms of Service for violations such as, but not limited to, pornographic, obscene, or defamatory material. BoardGameGeek may remove such User Submissions and/or terminate a user's access for uploading such material in violation of these Terms of Service at any time, without prior notice and at its sole discretion. Accounts and the personal information we possess about you will be deleted in accordance with our [Privacy Policy](https://github.com/GameNightAI/GameNight/blob/develop/PRIVACY_POLICY.md). If you have had your account terminated for cause, you are not permitted to create a new account.

# 10. BoardGameGeek is based in the USA and may not be usable in your country
...
## A. Think there is infringing content on BoardGameGeek?
...
* (iv) Your name, address, telephone number, and e-mail address, a statement that you consent to the jurisdiction of the federal court in Albany, New York, and a statement that you will accept service of process from the person who provided notification of the alleged infringement or an agent of such person.
...
* the use, inability to use, or the results of use of The Geek Websites, any website linked to the Geek Websites, or our content;
* loss, damage, corruption or recovery of data, or breach of data or system security;
* failure or downtime of the Geek Websites, systems, or services in any way;
...
in any case, whether based on warranty, contract, tort or any other legal theory and whether or not BoardGameGeek or a related party is aware of or of advised the possibility of such damages.
...
These Terms of Service, together with the BoardGameGeek Privacy Policy incorporated herein by reference and the BoardGameGeek Community Rules incorporated herein by reference, constitute the entire agreement between you and BoardGameGeek with respect to the Geek Websites, and supersede and replace any other agreement, document, correspondence, negotiation, conversation, or other written or oral understanding between you and BoardGameGeek with respect to the subject matter of this agreement.
