/*
  ...
  2. Security
    ...
    - Add policies for authenticated users to:
      - Create and read their own polls
      - Read poll games for polls they have access to
      - Create votes on polls
      - Read votes for polls they created
*/
